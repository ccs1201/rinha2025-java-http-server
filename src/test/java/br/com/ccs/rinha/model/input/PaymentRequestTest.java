...
class PaymentRequestTest {
    ...
    public static void main(String[] args) {
        ...
        byte[] modifiedJsonBytes = PaymentRequest.addRequestedAtToJsonBytes(originalJsonBytes);
        ...
        byte[] modifiedSingleLine = PaymentRequest.addRequestedAtToJsonBytes(singleLineBytes);
        ...
        var paymentDefault = PaymentRequest.parseToDefault(modifiedJsonBytes);
